...
public class PacienteController {
    ...
    public Page<DadosListagemPaciente> listar(Pageable paginacao){ // criar DTO de Dados listagem medico // Pageabe para fazer paginacao e passa como paramentro no findall
